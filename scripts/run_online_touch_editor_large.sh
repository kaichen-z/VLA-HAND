...
REPO_ROOT="${REPO_ROOT:-/home/chonghej/scratch/chonghej/vla_touch}"
...
CHECKPOINT="${CHECKPOINT:-/home/chonghej/scratch/chonghej/VLA-HAND/runs/gigahands_real_all_cam0_keypoints_mano_vitra3b_linked_train/checkpoints/gigahands_real_all_cam0_keypoints_mano_vitra3b_linked_stage1_TB2_B2_bf16True/checkpoints/epoch=0-step=140000.ckpt}"
...
if [[ ! -f "${DATASET_ROOT}/Annotation/opentouch_keypoint_train/episode_frame_index.npz" ]]; then
  ...
  echo "Dataset already exists at ${DATASET_ROOT}; skipping conversion."
fi
...
run_root = Path("runs/online_touch_editor_large")
rows = []
